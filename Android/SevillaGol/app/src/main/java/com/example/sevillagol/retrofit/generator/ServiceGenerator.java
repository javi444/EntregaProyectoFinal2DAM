package com.example.sevillagol.retrofit.generator;
...
public class ServiceGenerator {
    ...
    private static final String BASE_URL = "https://sevillagol.herokuapp.com/";
    public static String MASTER_KEY = "qZQDzsmwYO5GnOclZbRzdCLPyfW16uAe";
